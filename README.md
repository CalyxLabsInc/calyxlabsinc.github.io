...
Search the project for `placeholder`, `.example`, `YOUR_VERIFIED`, and `href="#"`.

## Structure

- `index.html`, `about.html`, `projects.html`, `contact.html`, `donations.html`
- `projects/`: individual Learn More pages
- `whitepapers/`: individual whitepapers and index
- `assets/`: shared CSS and JavaScript

No build step or third-party libraries are required.
